...
if (answers.operator == "Addition") {
    let sum_of_two_number = answers.num1 + answers.num2;
    console.log("Sum of two number is : ", sum_of_two_number);
}
else if (answers.operator === "Subtraction") {
    let subtraction_of_two_number = answers.num1 - answers.num2;
    console.log("Subtraction of two number is : ", subtraction_of_two_number);
}
else if (answers.operator === "Multiplication") {
    let multiple_of_two_number = answers.num1 * answers.num2;
    console.log("Multiplication of two number is : ", multiple_of_two_number);
}
else if (answers.operator === "Division") {
    let division_of_two_number = answers.num1 / answers.num2;
